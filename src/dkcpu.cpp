...
void LoadCPUInstructions(CPU *cpu)
{
	...
	Operation<0x03, add, true, 
		Register<4>, 
		Indirect<32, Register<4>, 16>, 
		NullVal<0>, 
		0>::Register(cpu, "ld");
	...
	Operation<0x06, xor, true, 
		Register<4>, 
		Register<4>, 
		Register<4>, 
		4>::Register(cpu, "xor");

	Operation<0x07, and, true, 
		Register<4>, 
		Register<4>, 
		Register<4>, 
		4>::Register(cpu, "and");

	Operation<0x08, or , true, 
		Register<4>, 
		Register<4>, 
		Register<4>, 
		4>::Register(cpu, "or");

	Operation<0x09, not, true, 
		Register<4>, 
		Register<4>, 
		NullVal<4>, 
		4>::Register(cpu, "not");

	Operation<0x0a, add, true, 
		Register<4>, 
		Register<4>, 
		Register<4>, 
		4>::Register(cpu, "add");

	Operation<0x0b, sub, true, 
		Register<4>, 
		Register<4>,
		Register<4>, 
		4>::Register(cpu, "sub");
	...
	Operation<0xf0, jmp, false, 
		NullVal<0>, 
		Immediate<32>, 
		NullVal<0>, 
		0>::Register(cpu, "jmp");

	Operation<0xf1, jz , false, 
		NullVal<0>, 
		Immediate<32>, 
		NullVal<0>, 
		0>::Register(cpu, "jz");

	Operation<0xf2, jnz, false, 
		NullVal<0>, 
		Immediate<32>, 
		NullVal<0>, 
		0>::Register(cpu, "jnz");
